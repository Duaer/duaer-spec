/**
 * Duaer-spec FDE (live console) i18n — zh-CN (default) + zh-TW + en + ja + ko +
...
const zhCN = {
  ...
  "project.toggle": "项目",
  "employee.toggle": "数字员工",
  "employee.mark": "Employees",
  "employee.title": "数字员工",
  "employee.close": "关闭",
  "employee.lead": "开工按任务角色分派。实现写功能；功能回归对照验收与 testing.md 跑测（优先 Playwright），不改业务范围；部署按计划托管上线。运行时仍是 Cursor Agent / Claude Code。",
  "employee.role": "角色 {role}",
  "employee.runtime": "运行时 · Cursor / Claude",
  "employee.implementer.name": "实现员工",
  "employee.implementer.cap": "按 Acceptance 实现功能；更新 README；启动预览并 stamp 交付。",
  "employee.regression.name": "功能回归",
  "employee.regression.cap": "对照验收与 .duaer/memory/testing.md 做 L0–L3 回归（优先 Playwright / npm test）；写测、跑测、留证据；不改业务范围；失败不 stamp accepted。",
  "verify.missing": "缺少机器验收命令（.duaer/memory/verify.json）",
  "verify.invalid": "机器验收契约无法读取（.duaer/memory/verify.json）",
  "verify.fail": "机器验收未通过：{command} 退出码 {code}",
  "employee.deployer.name": "部署员工",
  "employee.deployer.cap": "按计划托管上线：Cloudflare / 阿里云 / AWS / GitHub Pages；写入公网预览地址。",
  "project.mark": "Project",
  "project.title": "项目与对话",
  "project.close": "关闭",
  "project.restore": "恢复到当前控制台",
  "project.createTitle": "新建项目",
  "project.listTitle": "已有项目",
  "project.convTitle": "当前项目的对话",
  "project.nameLabel": "新建目录名",
  "project.namePh": "my-app",
  "project.folderLabel": "新建目录名",
  ...
  "project.activate": "新建并打开",
  "project.working": "正在切换项目…",
  "project.browse": "浏览打开…",
  "project.createHint": "先选父目录，再填短名、名称与背景。短名不能带路径，也不能与已有目录或项目重名。已有项目从下方列表打开，或点「浏览打开…」。",
  "project.pathExists": "项目目录已存在，请换一个目录名，或从「已有项目」打开",
  "project.needShortName": "新建只能填目录短名，不要填绝对路径",
  "project.titleExists": "已有同名项目，请换一个项目名称，或从「已有项目」打开",
  ...
  "setup.title": "配置模型",
  "setup.hint": "先接好 Duaer 控制台模型，再在控制台说需求。写入 ~/.duaer/live/config.json",
  ...
  "setup.modelBlock": "控制台模型",
  "setup.sttBlock": "语音识别模型",
  "setup.sttHint": "录音结束后用此模型解码成文字。需兼容 OpenAI `/v1/audio/transcriptions`（如 whisper-1）。",
  "setup.sttSave": "保存语音模型",
  "setup.sttClear": "清除",
  "setup.sttSaved": "语音识别模型已保存",
  "setup.sttCleared": "已清除语音识别模型",
  "setup.sttNeedFields": "请填写 STT Base URL、Model，并提供 API Key",
  "setup.howtoStt1": "OpenAI：Base URL 填 https://api.openai.com/v1，Model 填 whisper-1",
  "setup.howtoStt2": "其它兼容服务（Groq / 本地 Whisper 等）填对应 Base URL 与模型名",
  "setup.howtoStt3": "与上方控制台聊天模型分开；未配置时点录音会打开本设置引导填写",
  "setup.howtoFill": "怎么填？",
  "setup.howtoGet": "怎么拿？",
  ...
  "setup.open": "设置",
  "setup.close": "关闭",
  "setup.back": "返回 Duaer 控制台",
  "setup.guideAria": "说明",
  "setup.guideTitle": "派工与模型说明",
  "setup.guideLead": "Duaer 控制台聊天模型 ≠ 派工用的数字员工 CLI，两边都要配好。",
  "setup.guideDeskTitle": "Duaer 控制台模型（本页）",
  ...
  "setup.guideOther1": "Duaer 控制台用其它模型：选 Custom，填该服务商的 Base URL / Key / Model 名",
  ...
  "chat.send": "发送",
  "chat.voice": "录音",
  "chat.voiceListening": "录音中…",
  "chat.voiceRecognizing": "识别中…",
  "chat.voiceHint": "先在设置里配置语音识别模型，再录音收集需求",
  "chat.voiceHintStt": "录音 → 语音模型解码 → 填入输入框",
  "chat.voiceUnsupported": "当前浏览器不支持录音",
  "chat.voiceDenied": "无法使用麦克风，请检查权限后重试",
  "chat.voiceError": "录音/识别失败：{msg}",
  "chat.voiceNeedStt": "请先配置语音识别模型，再录音。已打开设置 →「语音识别模型」",
  "chat.voiceSttHint": "录音需要语音识别模型：在设置里填写 STT Base URL / API Key / Model（如 whisper-1）",
  "chat.voiceEmpty": "没有识别到有效语音，请再说一次",
  "chat.quickNav": "导航",
  "chat.quickNavHint": "跳到对话底部、确认卡、结果或进度",
  "chat.navChat": "对话底部",
  "chat.navCard": "确认卡",
  "chat.navResult": "结果",
  "chat.navProgress": "进度",
  ...
  "chat.emptyStep2": "用大白话说想要什么（也可点「录音」口述）",
  ...
  "card.title": "需求",
  "card.aria": "需求",
  "card.bugMark": "Defect card",
  "card.bugTitle": "缺陷",
  "card.bugModuleTitle": "缺陷",
  "card.bugGoal": "缺陷现象",
  "card.bugOut": "本次不改",
  "card.bugAccept": "修好标准",
  "card.bugAcceptHint": "写可核对结果：复现关闭、打开何处、看到什么、哪条命令通过",
  "card.bugAssume": "环境 / 原因",
  "card.bugConfirm": "确认缺陷卡",
  "card.kindFeature": "需求",
  "card.kindBug": "修 bug",
  "card.kindSwitchAria": "需求或修 bug",
  "card.goal": "要做什么",
  "card.out": "不做什么",
  "card.accept": "验收标准",
  ...
  "card.device": "浏览器/设备矩阵",
  "card.deviceHint": "至少两个具体浏览器或国产终端，并写截图/云测证据和降级策略",
  "card.devicePh": "例：Chrome 最近两版、手机 Safari、统信 UOS；云测截图放 compat/；旧壳降级提示升级",
  "card.paths": "关键路径",
  "card.pathsHint": "联调必须覆盖的主路径",
  "card.pathsPh": "例：登录 → 首页 → 提交表单",
  "card.exceptions": "异常态",
  "card.exceptionsHint": "须覆盖空态、失败、权限不足、超时、可重试；有接口时写错误码",
  "card.exceptionsPh": "例：空列表提示；提交失败可重试；权限不足；超时；错误码 403",
  "card.apiContract": "接口契约",
  "card.apiContractHint": "OpenAPI/类型路径；无 HTTP API 则写「本模块无 HTTP API」",
  "card.apiContractPh": "例：openapi/openapi.yaml 或 本模块无 HTTP API",
  "card.envChecklist": "环境检查",
  "card.envChecklistHint": "开工前 DNS、TLS、CORS、鉴权、第三方可达须全部通过；无客户联调则写「无客户联调环境」",
  "card.envChecklistPh": "例：DNS 通过；TLS 证书通过；CORS 通过；鉴权通过；第三方可达。或写「无客户联调环境」",
  "card.dataPrecheck": "数据预检",
  "card.dataPrecheckHint": "须写字段映射、导入预检失败清单，并说明可导出；无导入则写「本模块无导入」",
  "card.dataPrecheckPh": "例：字段映射见 mapping.csv；导入预检失败清单；可导出给业务清洗。或写「本模块无导入」",
  "card.externalDeps": "外部依赖",
  "card.externalDepsHint": "第三方/ERP/SSO 须写阻塞项、SLA、备用 Mock、并行路径；没有则写「本模块无外部依赖」",
  "card.externalDepsPh": "例：阻塞项：厂商接口；SLA 2 天；备用 Mock；并行路径不走 SSO。或写「本模块无外部依赖」",
  "card.perfBudget": "性能预算",
  "card.perfBudgetHint": "须写 LCP、INP、包体、长列表虚拟滚动、弱网和大数据压测；写「挺快的」不能过。没有页面则写「本模块无页面性能要求」",
  "card.perfBudgetPh": "例：LCP 2.5s；INP 200ms；包体 < 200KB；长列表虚拟滚动；弱网 3G；大数据压测。或写「本模块无页面性能要求」",
  "card.reqAdd": "添加一条",
  "card.reqRemove": "删除这条",
  "baseline.mark": "范围+验收基线（FDE-01）",
  "baseline.hint": "无签字基线不得开工；变更须开变更单并重新签署",
  "baseline.signer": "签字人",
  "baseline.signerPh": "姓名或角色",
  "baseline.sign": "签署基线",
  "baseline.change": "开变更",
  "baseline.changeReason": "变更说明",
  "baseline.changePh": "为何改范围/验收",
  "baseline.waitConfirm": "先确认全部模块与架构，再签署基线",
  "baseline.needSign": "请签署范围+验收基线后再开工",
  "baseline.needSignBtn": "请先签署基线",
  "baseline.needSigner": "请填写签字人",
  "baseline.needChangeReason": "请填写变更说明",
  "baseline.signedLine": "已签署 · {signer} · {at}",
  "baseline.signedOk": "基线已由 {signer} 签署。可以开工派工。",
  "baseline.changeOpened": "已开变更：模块需重新确认，架构需再确认，并重新签署基线。",
  "card.lockHint": "确认前自动校验；通过后锁定本模块（尚未开工）",
  "card.lockHintLocked": "已确认。选择产品仓库派工，Brief 才会进入业务仓 worktree。",
  "card.lockHintReady": "校验已通过，可以确认发出。",
  "card.lockHintNeed": "至少填好「要做什么」、可检查验收，以及设备矩阵 / 关键路径 / 异常态 / 接口契约。",
  ...
  "card.confirm": "确认本模块",
  "card.confirmed": "本模块已确认",
  "card.confirmModule": "确认本模块",
  "card.allModulesConfirmed": "全部模块已确认",
  "card.moduleDraft": "草稿",
  "card.moduleReady": "可确认",
  "card.moduleConfirmed": "已确认",
  "card.modulesProgress": "模块 {done}/{total} 已确认",
  "bot.allModulesOk": "全部模块需求已确认。接下来设计架构，确认架构后再开工。",
  "bot.bugReadyDispatch": "缺陷卡已确认。默认跳过架构，可在中间栏拆任务并派工；需要时再设计架构。",
  "bot.bugKindPicked": "已切到修 bug。在中间栏填缺陷卡，或直接说现象与复现。",
  "result.moduleExtra": "进度：{done}/{total}。",
  "result.allModulesExtra": "可开始架构设计。",
  "dispatch.taskPool": "任务池（依赖 / 并行）",
  "dispatch.taskGraph": "任务执行路径",
  "dispatch.taskGraphHint": "节点颜色与标签显示进度；过长链路自动换行。调度中心整页实时刷新状态",
  "dispatch.center": "调度中心",
  "dispatch.openGraph": "查看派工图",
  "dispatch.centerEmpty": "还没有派工图",
  "dispatch.viewGraph": "派工图",
  "dispatch.viewArchitecture": "系统架构",
  "dispatch.centerArchEmpty": "这个项目还没有系统架构图",
  "dispatch.decomposeTitle": "任务拆解",
  "dispatch.decomposeHint": "架构确认后按验收条目拆到原子任务；可并行的会标出来",
  "dispatch.bugHotfix": "线上紧急：从 main 出 fix 分支",
  "dispatch.redecompose": "重新拆解",
  "dispatch.decomposeEmpty": "尚未拆解任务",
  "dispatch.parallelChip": "可并行",
  "dispatch.confirmWorkersGraph": "确认人数并生成派工图",
  "dispatch.regenWorkersGraph": "重新确认并生成派工图",
  "dispatch.confirmWorkersLocked": "已确认并生成派工图",
  "dispatch.graphBuilding": "正在生成派工图…",
  "dispatch.graphBuildFail": "派工图生成失败",
  "dispatch.graphBuildFailDetail": "派工图生成失败：{msg}",
  "dispatch.graphBuilt": "已按 {n} 名数字员工生成派工图，可查看或启动",
  "dispatch.recommendWorkers": "推荐 {n} 人（按可并行宽度）",
  "dispatch.needGraphConfirm": "请先确认人数并生成派工图",
  "dispatch.graphStale": "人数已改，请重新确认并生成派工图",
  "dispatch.workerCount": "数字员工数量",
  "dispatch.workerCountHint": "默认按并行宽度推荐；多人时末位泳道做功能回归与部署（verify-l3 / deploy）",
  "dispatch.workerSerial": "串行",
  "dispatch.workerParallel": "并行",
  "dispatch.needModules": "请先确认全部模块",
  "card.validating": "校验中…",
  "card.accepting": "锁定中…",
  "card.fixing": "自动修正中…",
  ...
  "arch.bugSkipHint": "缺陷默认跳过系统架构，可直接拆任务派工；若改到接口/数据/安全边界再点下方设计架构",
  "arch.bugSkippedSummary": "缺陷派工：已跳过系统架构（可选补设计）",
  "arch.bugOptionalDesign": "需要时设计架构",
  ...
  "dispatch.do": "写入 Brief 并开工",
  "dispatch.doWithAgent": "开工并用 {label} 启动",
  "dispatch.done": "已开工",
  "dispatch.working": "开工中…",
  "preview.title": "结果",
  ...
  "bot.confirmFixed":
    "已自动修正并确认本模块。可继续聊其它模块；全部确认后再架构与开工。",
  "bot.confirmOk":
    "本模块已确认。可继续聊其它模块；全部确认后再做架构与开工。",
  ...
  "run.dispatchWorkersSummary": "{n} 名员工 · {done}/{total} · {current}",
  "run.worker": "员工 {id}",
  "run.workerRunning": "进行中",
  "run.workerQueued": "排队中",
  "run.workerWaiting": "待领取",
  "run.workerWaitingDeps": "等依赖",
  "run.workerDone": "已完成",
  "run.orchSummary": "编排：已放行 {released} 波 · 就绪 {ready} · 阻塞 {blocked}",
  "run.workerIdle": "待命",
...
const en = {
  ...
  "theme.toLight": "Light",
  "theme.toDark": "Dark",
  "theme.aria": "Switch light or dark theme",
  "github.label": "GitHub",
  ...
  "history.close": "Close",
  "history.restore": "Restore to console",
  ...
  "employee.toggle": "Employees",
  "employee.mark": "Employees",
  "employee.title": "Digital employees",
  "employee.close": "Close",
  "employee.lead": "Kickoff assigns by task role. Implementer builds; Functional regression checks acceptance via testing.md (prefer Playwright) without changing product scope; Deployer ships to the planned host. Runtime is still Cursor Agent / Claude Code.",
  "employee.role": "Role {role}",
  "employee.runtime": "Runtime · Cursor / Claude",
  "employee.implementer.name": "Implementer",
  "employee.implementer.cap": "Build to Acceptance; update README; start preview and stamp delivery.",
  "employee.regression.name": "Functional regression",
  "employee.regression.cap": "Check acceptance against .duaer/memory/testing.md (L0–L3; prefer Playwright / npm test); write, run, evidence; no product-scope edits; do not stamp accepted on failure.",
  "verify.missing": "Missing machine verify commands (.duaer/memory/verify.json)",
  "verify.invalid": "Machine verify contract is unreadable (.duaer/memory/verify.json)",
  "verify.fail": "Machine verify failed: {command} exit {code}",
  "employee.deployer.name": "Deployer",
  "employee.deployer.cap": "Ship to planned host: Cloudflare / Alibaba Cloud / AWS / GitHub Pages; write public preview URL.",
  "project.mark": "Project",
  "project.title": "Projects & chats",
  "project.close": "Close",
  "project.restore": "Restore to console",
  ...
  "project.working": "Switching project…",
  ...
  "setup.hint": "Connect a Duaer console model first, then state the job. Saved to ~/.duaer/live/config.json",
  ...
  "setup.modelBlock": "Console model",
  "setup.sttBlock": "Speech recognition model",
  "setup.sttHint": "After Record stops, this model decodes speech to text. OpenAI-compatible `/v1/audio/transcriptions` (e.g. whisper-1).",
  "setup.sttSave": "Save speech model",
  "setup.sttClear": "Clear",
  "setup.sttSaved": "Speech recognition model saved",
  "setup.sttCleared": "Speech recognition model cleared",
  "setup.sttNeedFields": "Fill STT Base URL, Model, and API Key",
  "setup.howtoStt1": "OpenAI: Base URL https://api.openai.com/v1, Model whisper-1",
  "setup.howtoStt2": "Other compatible hosts (Groq / local Whisper): use their Base URL and model id",
  "setup.howtoStt3": "Separate from the console chat model; without STT, Record opens this Settings block",
  ...
  "setup.open": "Settings",
  "setup.close": "Close",
  "setup.back": "Back to Duaer console",
  "setup.guideAria": "Guide",
  "setup.guideTitle": "Workers & models",
  "setup.guideLead": "Duaer console chat model ≠ worker CLI used for dispatch — configure both.",
  "setup.guideDeskTitle": "Duaer console model (this page)",
  ...
  "setup.guideOther1": "Other Duaer console models: choose Custom and fill that provider’s Base URL / Key / Model",
  ...
  "chat.send": "Send",
  "chat.voice": "Record",
  "chat.voiceListening": "Recording…",
  "chat.voiceRecognizing": "Recognizing…",
  "chat.voiceHint": "Configure a speech model in Settings, then Record to collect requirements",
  "chat.voiceHintStt": "Record → STT model decode → fill the composer",
  "chat.voiceUnsupported": "This browser does not support recording",
  "chat.voiceDenied": "Microphone unavailable — check permissions and retry",
  "chat.voiceError": "Voice failed: {msg}",
  "chat.voiceNeedStt": "Configure a speech recognition model first. Opened Settings → Speech recognition model",
  "chat.voiceSttHint": "Record needs an STT model: set STT Base URL / API Key / Model in Settings (e.g. whisper-1)",
  "chat.voiceEmpty": "No speech recognized — try again",
  "chat.quickNav": "Nav",
  "chat.quickNavHint": "Jump to chat bottom, confirm card, result, or progress",
  "chat.navChat": "Chat bottom",
  "chat.navCard": "Confirm card",
  "chat.navResult": "Result",
  "chat.navProgress": "Progress",
  "chat.emptyMark": "Duaer-spec FDE",
  ...
  "chat.emptyStep2": "Say what you want in plain words (or tap Record)",
  ...
  "card.bugMark": "Defect card",
  "card.bugTitle": "Defect",
  "card.bugModuleTitle": "Defect",
  "card.bugGoal": "Symptom / repro",
  "card.bugOut": "Do not change",
  "card.bugAccept": "Fixed when",
  "card.bugAcceptHint":
    "Checkable: repro closed, open where / see what / which command passes",
  "card.bugAssume": "Env / cause",
  "card.bugConfirm": "Confirm defect card",
  "card.kindFeature": "Feature",
  "card.kindBug": "Fix a bug",
  "card.kindSwitchAria": "Feature or fix a bug",
  "card.goal": "Goal",
  ...
  "card.lockHintNeed":
    "Fill goal, checkable acceptance, plus device matrix / critical paths / exceptions / API contract.",
  ...
  "card.confirm": "Confirm this module",
  "card.confirmed": "Module confirmed",
  "card.confirmModule": "Confirm this module",
  "card.allModulesConfirmed": "All modules confirmed",
  "card.moduleDraft": "Draft",
  ...
  "bot.bugReadyDispatch":
    "Defect card confirmed. Architecture skipped by default — decompose and dispatch in the center column; design architecture only if needed.",
  "bot.bugKindPicked":
    "Switched to fix-a-bug. Fill the defect card in the center column, or describe the symptom and repro.",
  ...
  "dispatch.taskGraphHint": "Node color and tag show progress; long chains wrap. Dispatch center refreshes status live",
  "dispatch.center": "Dispatch center",
  "dispatch.openGraph": "View dispatch graph",
  "dispatch.centerEmpty": "No dispatch graph yet",
  "dispatch.viewGraph": "Dispatch graph",
  "dispatch.viewArchitecture": "Architecture",
  "dispatch.centerArchEmpty": "No system architecture diagram for this project yet",
  "dispatch.decomposeTitle": "Task breakdown",
  "dispatch.decomposeHint": "After architecture confirm, split acceptance into atomic tasks; parallel ones are marked",
  "dispatch.bugHotfix": "Production hotfix: branch fix/ from main",
  "dispatch.redecompose": "Re-decompose",
  "dispatch.decomposeEmpty": "No tasks yet",
  "dispatch.parallelChip": "Parallel",
  "dispatch.confirmWorkersGraph": "Confirm count and build dispatch graph",
  "dispatch.regenWorkersGraph": "Reconfirm and rebuild dispatch graph",
  "dispatch.confirmWorkersLocked": "Confirmed — dispatch graph ready",
  "dispatch.graphBuilding": "Building dispatch graph…",
  "dispatch.graphBuildFail": "Failed to build dispatch graph",
  "dispatch.graphBuildFailDetail": "Dispatch graph failed: {msg}",
  "dispatch.graphBuilt": "Dispatch graph ready for {n} digital employees — view or launch",
  "dispatch.recommendWorkers": "Recommended: {n} (from parallel width)",
  "dispatch.needGraphConfirm": "Confirm worker count and build the dispatch graph first",
  "dispatch.graphStale": "Worker count changed — confirm again to rebuild the graph",
  "dispatch.workerCount": "Digital employees",
  "dispatch.workerCountHint":
    "Recommended from parallel width; with more workers the last lane owns verify-l3 and deploy",
  "dispatch.workerSerial": "Serial",
  "dispatch.workerParallel": "Parallel",
  "dispatch.needModules": "Confirm all modules first",
  ...
  "arch.bugSkipHint":
    "Bugs skip system architecture by default — decompose and dispatch; design architecture only if contracts or security change",
  "arch.bugSkippedSummary": "Bug dispatch: architecture skipped (optional design)",
  "arch.bugOptionalDesign": "Design architecture if needed",
  ...
  "dispatch.do": "Write Brief and kick off",
  "dispatch.doWithAgent": "Kick off with {label}",
  "dispatch.done": "Kicked off",
  "dispatch.working": "Starting…",
  ...
  "bot.confirmFixed":
    "Auto-fixed and this module confirmed. Keep chatting other modules; architecture and kickoff after all are confirmed.",
  "bot.confirmOk":
    "Module confirmed. Keep chatting other modules; architecture and kickoff after all are confirmed.",
  ...
  "run.dispatchWorkersSummary": "{n} employees · {done}/{total} · {current}",
  "run.worker": "Employee {id}",
  "run.workerRunning": "Running",
  "run.workerQueued": "Queued",
  "run.workerWaiting": "Waiting",
  "run.workerWaitingDeps": "Waiting on deps",
  "run.workerDone": "Done",
  "run.orchSummary": "Orchestration: {released} waves released · {ready} ready · {blocked} blocked",
  "run.workerIdle": "Idle",
