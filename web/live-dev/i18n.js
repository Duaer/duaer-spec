...
const zhCN = {
  ...
  "card.lockHintChecking": "正在校验需求是否可执行…",
  "card.lockHintFailed": "校验未通过；请改卡或点自动修正。",
  "card.lockHintRevise": "改进卡同样需校验通过后才能续派。",
  "card.confirm": "需求无误，开始干活",
  "card.confirmed": "已确认",
  "card.validating": "校验中…",
  "card.accepting": "锁定中…",
  "card.fixing": "自动修正中…",
  "validate.checking": "校验中：检查是否可执行、验收是否可检查…",
  "validate.passed": "校验通过：{summary}",
  "validate.failed": "校验未通过：{summary}{detail}",
  "bot.needValidate": "请先等校验通过（或点自动修正）后再发出。交给数字员工的必须是可执行需求。",
...
const en = {
  ...
  "card.lockHintChecking": "Checking that the brief is executable…",
  "card.lockHintFailed": "Validation failed — edit the card or auto-fix.",
  "card.lockHintRevise": "Revise card must also pass validation before dispatch.",
  ...
  "validate.checking": "Validating: executable goal and checkable acceptance…",
  "validate.passed": "Validation passed: {summary}",
  "validate.failed": "Validation failed: {summary}{detail}",
  "bot.needValidate": "Wait for validation (or auto-fix) before sending. Digital employees only get executable briefs.",
