...
const zhCN = {
  ...
  "dispatch.taskGraphHint": "与系统架构图同一排版；色条表示数字员工分工。全屏查看可点节点看详情（不放大）",
...
const en = {
  ...
  "dispatch.taskGraphHint": "Same layout as system architecture; colors show worker lanes. Fullscreen: click nodes for details (no zoom)",
