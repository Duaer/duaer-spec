...
const zhCN = {
  ...
  "preview.noPage": "还没有可打开的地址。可以先打开项目目录看看。",
  "preview.folderHint": "代码在：{path}",
  "preview.opened": "项目目录已打开",
  "preview.openFail": "打不开项目目录：{msg}",
  "preview.starting": "正在启动服务…",
  "preview.ready": "服务已在监听",
  "preview.startFail": "服务没起来：{msg}",
  "preview.startService": "启动服务",
  "preview.serviceListening": "监听中 · {url}",
  "preview.serviceDown": "未启动 · {url}",
  "preview.serviceChecking": "正在检查服务…",
  "preview.serviceStatic": "静态页面，无需本地服务",
  "preview.auto": "网页",
  "preview.link": "\n打开看看：{url}",
  "preview.missing":
...
const en = {
  ...
  "preview.noPage": "Nothing to open yet. You can open the project folder first.",
  "preview.folderHint": "Code is at: {path}",
  "preview.opened": "Project folder opened",
  "preview.openFail": "Could not open project folder: {msg}",
  "preview.starting": "Starting the service…",
  "preview.ready": "Service is listening",
  "preview.startFail": "Service did not start: {msg}",
  "preview.startService": "Start service",
  "preview.serviceListening": "Listening · {url}",
  "preview.serviceDown": "Not running · {url}",
  "preview.serviceChecking": "Checking service…",
  "preview.serviceStatic": "Static page — no local service needed",
  "preview.auto": "page",
  "preview.link": "\nOpen: {url}",
  "preview.missing":
