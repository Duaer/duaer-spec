...
const zhCN = {
  ...
  "setup.title": "配置模型",
  "setup.hint": "先接好台面模型，再在台面说需求。写入 ~/.duaer/live/config.json",
  "setup.provider": "服务商",
  ...
  "setup.guideAria": "说明",
  "setup.guideTitle": "说明",
  "setup.guideLead": "台面聊天模型 ≠ 派工用的数字员工 CLI，两边都要配好。",
  "setup.guideDeskTitle": "台面模型（本页）",
  ...
  "setup.guideOther1": "台面用其它模型：选 Custom，填该服务商的 Base URL / Key / Model 名",
  ...
  "arch.hintDesigning": "正在左侧对话设计架构（Duaer）…",
  "arch.hintPreview": "预览如下。满意则确认架构，再派工。",
  "arch.hintConfirmed": "架构已确认；数字员工将按此图开发。",
  "arch.hintStale": "需求已变更，请更新并重新确认架构后再派工。",
  "arch.confirm": "确认架构，可派工",
  "arch.confirmed": "架构已确认",
  "arch.enterDesign": "需求已确认。接下来在对话里一起定系统架构——我会先问一个关键问题。",
  "arch.kickoff": "需求已确认。计划托管：{target}。请根据需求卡设计系统架构（组件与连接），准备好后给出可渲染的架构 JSON。",
  "arch.kickoffInternal": "（系统）需求已确认。计划托管：{target}。请根据需求卡只问一个最关键的架构问题（前后端、数据或托管边界）。先说话，再 <<<JSON>>>（未成型 ready=false）。不要派工。",
...
const en = {
  ...
  "setup.hint": "Connect a desk model first, then state the job. Saved to ~/.duaer/live/config.json",
  ...
  "setup.open": "Settings",
  "setup.close": "Close",
  "setup.back": "Back to desk",
  "setup.guideAria": "Guide",
  "setup.guideTitle": "Guide",
  "setup.guideLead": "Desk chat model ≠ worker CLI used for dispatch — configure both.",
  "setup.guideDeskTitle": "Desk model (this page)",
  ...
  "setup.guideOther1": "Other desk models: choose Custom and fill that provider’s Base URL / Key / Model",
  ...
  "arch.hintDesigning": "Designing architecture in the left chat (Duaer)…",
  "arch.hintPreview": "Preview below. Confirm when ready, then dispatch.",
  ...
  "arch.enterDesign": "Requirements confirmed. Next we design the system architecture in chat — I'll ask one key question first.",
  "arch.kickoff": "Requirements confirmed. Planned host: {target}. Design the system architecture (components + connections), then emit renderable architecture JSON.",
  "arch.kickoffInternal": "(system) Requirements confirmed. Planned host: {target}. Ask one key architecture question (frontend/backend, data, or hosting boundary). Speak first, then <<<JSON>>> (ready=false until shaped). Do not dispatch.",
