...
const zhCN = {
  ...
  "dispatch.pathHint": "默认使用当前项目；要换项目请打开右上角「项目」",
...
const en = {
  ...
  "dispatch.mark": "Dispatch · product repo",
  "dispatch.title": "Dispatch to current project",
  ...
  "dispatch.pathPh": "/Users/…/your-product",
  "dispatch.pathHint": "Uses the current project; change it under Projects",
