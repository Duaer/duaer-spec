...
const zhCN = {
  ...
  "setup.aliyunHint": "填写 AccessKey 后，「计划托管 / 部署」才会显示阿里云。密钥只存本机，不会回传到页面。",
  "setup.aliyunId": "AccessKey ID",
  "setup.aliyunSecret": "AccessKey Secret",
  "setup.aliyunSave": "保存阿里云凭证",
  ...
  "setup.cloudflareHint": "填写 API Token 与 Account ID 后，「计划托管 / 部署」才会显示 Cloudflare。密钥只存本机。",
  "setup.cloudflareToken": "API Token",
  "setup.cloudflareAccount": "Account ID",
  "setup.cloudflareSave": "保存 Cloudflare 凭证",
...
const en = {
  ...
  "setup.aliyunId": "AccessKey ID",
  "setup.aliyunSecret": "AccessKey Secret",
  "setup.aliyunSave": "Save Alibaba Cloud keys",
  ...
  "setup.cloudflareHint": "After API Token and Account ID are saved, Cloudflare appears in planned host / Deploy. Keys stay on this machine only.",
  "setup.cloudflareToken": "API Token",
  "setup.cloudflareAccount": "Account ID",
  "setup.cloudflareSave": "Save Cloudflare keys",
  ...
  "setup.awsHint": "After Access Key is saved, AWS appears in planned host / Deploy. Keys stay on this machine only.",
  "setup.awsId": "Access Key ID",
  "setup.awsSecret": "Secret Access Key",
  "setup.awsRegion": "Region (optional)",
  "setup.awsSave": "Save AWS keys",
