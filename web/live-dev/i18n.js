...
const zhCN = {
  ...
  "arch.hintStale": "需求已变更，请更新并重新确认架构后再派工。",
  ...
  "preview.title": "结果",
  "preview.view": "查看结果",
  "preview.openFolder": "打开项目目录",
  "preview.noPage": "没有可打开的页面；可打开项目目录查看交付物。",
  "preview.folderHint": "项目目录：{path}",
  "preview.opened": "已在访达中打开",
  "preview.openFail": "无法打开目录：{msg}",
  "preview.auto": "自动发现",
  "preview.link": "\n结果：{url}",
  "preview.missing":
...
const en = {
  ...
  "arch.hintStale": "Requirements changed — update and re-confirm architecture before dispatch.",
  ...
  "preview.openFolder": "Open project folder",
  "preview.noPage": "No openable page; open the project folder to inspect the delivery.",
  "preview.folderHint": "Project folder: {path}",
  "preview.opened": "Opened in Finder",
