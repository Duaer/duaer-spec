...
const zhCN = {
  ...
  "chat.send": "发送",
  "chat.emptyMark": "Field Engineering Desk",
  "chat.emptyTitle": "用一句话说清要交付什么",
  "chat.emptyHint": "中间栏会整理成可检查验收；右侧显示写代码进度",
  ...
  "card.lockHintFailed": "校验未通过；请改卡或点自动修正。",
  ...
  "bot.needValidate": "请先等校验通过（或点自动修正）后再发出。交给数字员工的必须是可执行、可验收的需求。",
  "bot.validateFixed": "已修正并校验通过：{summary}。可以确认发出。",
  "err.validate": "校验失败",
  ...
  "dispatch.agentHint": "检测本机 PATH 上的 Cursor Agent / Claude Code / DeepSeek 等",
  ...
  "err.code.NO_AGENT": "未检测到可用 CLI。请安装 Cursor Agent、Claude Code 或 DeepSeek（npm i -g deepseek-tui）后重试。",
...
const en = {
  ...
  "chat.send": "Send",
  "chat.emptyMark": "Field Engineering Desk",
  "chat.emptyTitle": "Say what should be delivered",
  "chat.emptyHint": "The middle column becomes checkable acceptance; the right tracks coding progress",
  "card.mark": "Confirm card",
  ...
  "card.lockHintFailed": "Validation failed — edit the card or auto-fix.",
  ...
  "bot.needValidate":
    "Wait for validation (or auto-fix) before sending. Digital employees only get executable, checkable briefs.",
  "bot.validateFixed": "Fixed and validated: {summary}. You can confirm.",
  ...
  "dispatch.agentHint": "Detects Cursor Agent / Claude Code / DeepSeek on PATH",
  ...
  "err.code.NO_AGENT":
    "No CLI found. Install Cursor Agent, Claude Code, or DeepSeek (`npm i -g deepseek-tui`), then retry.",
