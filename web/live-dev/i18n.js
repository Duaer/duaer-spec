...
const zhCN = {
  ...
  "preview.noPage": "还没有可打开的地址。可以先打开文件夹看看。",
  "preview.folderHint": "代码在：{path}",
  "preview.opened": "文件夹已打开",
  "preview.openFail": "打不开文件夹：{msg}",
  "preview.starting": "正在把服务拉起来…",
  "preview.ready": "服务已就绪，可以打开看看",
...
const en = {
  ...
  "preview.ready": "Service is ready — open it",
