...
const zhCN = {
  ...
  "project.nameLabel": "项目名或绝对路径",
  "project.namePh": "my-app 或 /Users/…/my-app",
  "project.activate": "选为当前项目",
  "project.browse": "浏览…",
  "project.createHint": "短名在父目录下创建；绝对路径直接打开。未选项目前不能对话。",
...
const en = {
  ...
  "project.nameLabel": "Name or absolute path",
  "project.namePh": "my-app or /Users/…/my-app",
  "project.activate": "Use as current project",
  "project.browse": "Browse…",
  "project.createHint": "Short names create under the parent folder. Chat stays locked until a project is selected.",
