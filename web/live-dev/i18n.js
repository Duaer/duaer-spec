...
const zhCN = {
  ...
  "employee.title": "数字员工",
  "employee.close": "关闭",
  "employee.lead": "派工时按任务角色分配；运行时仍是 Cursor Agent / Claude Code。",
  ...
  "employee.regression.cap": "Acceptance → testing.md L0–L3 / Playwright；写测、跑测、留证据；不改业务范围。",
...
const en = {
  ...
  "employee.lead": "Kickoff assigns by task role; runtime is still Cursor Agent / Claude Code.",
  ...
  "employee.regression.cap": "Acceptance → testing.md L0–L3 / Playwright; write, run, evidence; no product-scope edits.",
