...
const zhCN = {
  ...
  "setup.howtoStt3": "与上方控制台聊天模型分开；未配置时录音仍可试浏览器识别",
  "setup.howtoFill": "怎么填？",
  "setup.howtoGet": "怎么拿？",
  ...
  "chat.voiceHint": "录音说出需求；配置语音模型后会解码成文字",
  ...
  "chat.voiceNeedStt": "请先在设置里配置语音识别模型，再录音解码",
  "chat.voiceSttHint": "未配置语音模型时用浏览器临时识别；设置里可配 Whisper 等 STT 模型以更稳识别",
...
const en = {
  ...
  "setup.howtoStt3": "Separate from the console chat model; without STT, Record may use browser speech",
  ...
  "chat.voiceHint": "Record requirements; configure an STT model to decode into text",
  ...
  "chat.voiceNeedStt": "Configure a speech recognition model in Settings, then record",
  "chat.voiceSttHint": "No STT model yet — using browser speech for now. Set Whisper (etc.) in Settings for reliable decode",
