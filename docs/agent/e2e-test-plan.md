...
| E2E-183 | Bug path: defect card → skip architecture by default → short pool → `fix/` (optional hotfix from main) | `npm test` + `npm run test:live` + manual |
...
| E2E-183 | `239-bug-dispatch` | defect card, skip arch, fix/ branch |
