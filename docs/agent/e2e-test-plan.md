...
| E2E-086 | After Confirm, architecture dialogue + Archify HTML under hosting; gate dispatch; revise must re-confirm; ready chat says diagram is under hosting (not “confirm JSON”) | `npm test` + `npm run test:live` |
