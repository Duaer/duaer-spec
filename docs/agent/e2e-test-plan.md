...
| E2E-169 | Dispatch center: top control, 100px project rail, selected project's dispatch graph; dispatch card button opens the same view | `npm test` |
...
| E2E-169 | `223-dispatch-center` | dispatch center shows the selected project's graph |
